# Mermaid XY Chart Agent Guide

This public template accepts official Mermaid `xy` diagram syntax. Author Mermaid text in the `examples/basic.mmd` style and pass `.mmd` files to visual commands.

## When to use this template

Use this template when the requested diagram is a Mermaid XY Chart or an equivalent diagram that Mermaid documents under its Diagram Syntax.
...
```mermaid
---
title: Mermaid XY Chart Example
---
xychart-beta
  title "Latency Trend"
  x-axis [Mon, Tue, Wed, Thu]
  y-axis "p95 ms" 0 --> 500
  line [120, 180, 240, 190]
```
