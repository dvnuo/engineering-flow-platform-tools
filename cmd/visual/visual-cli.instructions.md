...
- First inspect templates with `visual template list --template-dir <templates/visual> --json` and `visual template get <template-id> --template-dir <templates/visual> --json`.
