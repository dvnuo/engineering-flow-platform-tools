# Mermaid User Journey Agent Guide

This public template accepts official Mermaid `journey` diagram syntax. Author Mermaid text in the `examples/basic.mmd` style and pass `.mmd` files to visual commands.

## When to use this template

Use this template when the requested diagram is a Mermaid User Journey or an equivalent diagram that Mermaid documents under its Diagram Syntax.
...
journey
  ...
  section Purchase
    ...
    Submit payment: 3: Customer, Payment API
