...
Download the release archive for your operating system and CPU architecture, extract it, and place `jira`, `confluence`, `jenkins`, `browser`, `inspect-image`, and `log` on your `PATH`.
