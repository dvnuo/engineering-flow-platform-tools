...
If the user names a website or describes its purpose without giving a URL, list the configured bookmarks first, match `name`, `aliases`, and `description`, then use the returned URL unchanged:
