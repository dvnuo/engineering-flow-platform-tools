...
func (c *Client) postJSON(ctx context.Context, path string, body any, out any) error {
	...
	req.Header.Set("User-Agent", "GitHubCopilotChat/0.41.0")
	req.Header.Set("Editor-Version", "vscode/1.133.0")
	req.Header.Set("Editor-Plugin-Version", "copilot-chat/0.41.0")
