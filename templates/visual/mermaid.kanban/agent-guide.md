# Mermaid Kanban Board Agent Guide

This public template accepts official Mermaid `kanban` diagram syntax. Author Mermaid text in the `examples/basic.mmd` style and pass `.mmd` files to visual commands.

## When to use this template

Use this template when the requested diagram is a Mermaid Kanban Board or an equivalent diagram that Mermaid documents under its Diagram Syntax.
