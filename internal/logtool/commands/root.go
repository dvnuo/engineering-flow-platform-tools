...
func logLLMTips() []string {
	return []string{
		...
		"Use log profile and log template list to understand volume, levels, and repeated patterns before drilling into individual evidence.",
		...
		"Use log group, log timeline, and log summarize for deterministic aggregation; summarize does not call an LLM.",
		"Use log export evidence with --dry-run first when writing redacted evidence files.",
