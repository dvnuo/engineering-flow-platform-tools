...
func TestCommandSemanticsMatrixJiraFamilies(t *testing.T) {
	...
	writeDryRuns := [][]string{
		...
		{"zephyr", "execution", "bulk-update-status", "--cycle-id", "1", "--project-id", "123", "--issues", "PROJ-T1,PROJ-T2", "--status", "PASS"},
		{"zephyr", "archive", "executions", "--execution-ids", "1,2", "--yes"},
		{"zephyr", "archive", "executions", "--cycle-id", "1", "--project-id", "123", "--issues", "PROJ-T1,PROJ-T2", "--yes"},
