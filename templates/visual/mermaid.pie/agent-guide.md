# Mermaid Pie Chart Agent Guide

This public template accepts official Mermaid `pie` diagram syntax. Author Mermaid text in the `examples/basic.mmd` style and pass `.mmd` files to visual commands.

## When to use this template

Use this template when the requested diagram is a Mermaid Pie Chart or an equivalent diagram that Mermaid documents under its Diagram Syntax.
...
```mermaid
---
title: Mermaid Pie Example
---
pie title Incident Sources
  "API" : 42
  "Database" : 24
  "Queue" : 18
  "Network" : 16
