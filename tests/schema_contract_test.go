...
func TestSchemaConcreteFlags(t *testing.T) {
	...
	requireFlags(t, schemaData(t, "browser", "session.start"), "name", "url", "profile", "port", "browser", "headless", "json")
	...
	requireFlags(t, schemaData(t, "browser", "page.extract"), "selector", "limit", "include-html", "max-html-bytes", "session", "target-id", "timeout")
	requireRequired(t, schemaData(t, "browser", "page.extract"), "selector")
	requireFlags(t, schemaData(t, "browser", "page.click"), "selector", "session", "target-id", "timeout")
	requireRequired(t, schemaData(t, "browser", "page.click"), "selector")
	requireFlags(t, schemaData(t, "browser", "page.type"), "selector", "text", "clear", "session", "target-id", "timeout")
	requireFlags(t, schemaData(t, "browser", "page.wait"), "selector", "duration-ms", "session", "target-id", "timeout")
	requireRequired(t, schemaData(t, "browser", "page.wait"), "selector", "duration-ms")
	requireFlags(t, schemaData(t, "browser", "page.screenshot"), "out", "full-page", "session", "target-id", "timeout")
