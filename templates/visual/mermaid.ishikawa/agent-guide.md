# Mermaid Ishikawa Diagram Agent Guide

This public template accepts official Mermaid `ishikawa` diagram syntax. Author Mermaid text in the `examples/basic.mmd` style and pass `.mmd` files to visual commands.

## When to use this template

Use this template when the requested diagram is a Mermaid Ishikawa Diagram or an equivalent diagram that Mermaid documents under its Diagram Syntax.
...
```mermaid
---
title: Mermaid Ishikawa Example
---
ishikawa
  title Checkout Latency Cause
  Database
    Slow query
    Lock wait
  Network
