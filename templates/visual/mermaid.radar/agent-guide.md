# Mermaid Radar Chart Agent Guide

This public template accepts official Mermaid `radar` diagram syntax. Author Mermaid text in the `examples/basic.mmd` style and pass `.mmd` files to visual commands.

## When to use this template

Use this template when the requested diagram is a Mermaid Radar Chart or an equivalent diagram that Mermaid documents under its Diagram Syntax.
...
```mermaid
---
title: Mermaid Radar Example
---
radar-beta
  title Platform Scores
  axis Reliability, Security, Cost, Velocity, Operability
  curve Current{4, 3, 2, 4, 3}
  curve Target{5, 4, 3, 5, 4}
```
