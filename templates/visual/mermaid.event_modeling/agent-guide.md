# Mermaid Event Modeling Diagram Agent Guide

This public template accepts official Mermaid `event_modeling` diagram syntax. Author Mermaid text in the `examples/basic.mmd` style and pass `.mmd` files to visual commands.

## When to use this template

Use this template when the requested diagram is a Mermaid Event Modeling Diagram or an equivalent diagram that Mermaid documents under its Diagram Syntax.
...
```mermaid
---
title: Mermaid Event Modeling Example
---
eventModeling
  title Order Event Modeling
  section Command
    Submit order
  section Event
    Order created
