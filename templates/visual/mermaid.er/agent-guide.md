# Mermaid Entity Relationship Diagram Agent Guide

This public template accepts official Mermaid `er` diagram syntax. Author Mermaid text in the `examples/basic.mmd` style and pass `.mmd` files to visual commands.

## When to use this template

Use this template when the requested diagram is a Mermaid Entity Relationship Diagram or an equivalent diagram that Mermaid documents under its Diagram Syntax.
...
```mermaid
---
title: Mermaid ER Diagram Example
---
erDiagram
