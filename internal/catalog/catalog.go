...
func flagType(name string) string {
	switch name {
	case "json", "verbose", "dry-run", "yes", "body-stdin", "minor-edit", "legacy", "include-template-defaults", "fail-fast":
		return "bool"
