...
Download the release archive for your operating system and CPU architecture, extract it, and place `jira`, `confluence`, `jenkins`, `aws-auth`, `browser`, `inspect-image`, and `visual` on your `PATH`.
