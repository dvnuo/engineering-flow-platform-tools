...
var mobileAutoCommands = []string{
	...
	"mobile-auto session list", "mobile-auto session search", "mobile-auto session get", "mobile-auto session mark", "mobile-auto session start", "mobile-auto session status", "mobile-auto session stop",
	"mobile-auto run start", "mobile-auto run status", "mobile-auto run recover", "mobile-auto run import", "mobile-auto run handoff", "mobile-auto run resume", "mobile-auto run finish",
