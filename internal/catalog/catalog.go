...
var explicit = map[string]explicitMeta{
	...
	"zephyr.execution.add-tests-to-cycle": {Description: "Add Jira Test issues to a Zephyr test cycle, optionally moving the resulting executions into a cycle folder.",
		Flags: []string{"cycle-id", "project-id", "version-id", "issues", "folder-id", "instance", "config", "json", "format", "verbose", "dry-run"}, Required: []string{"cycle-id", "project-id", "issues"}, Risk: "write", Example: "jira zephyr execution add-tests-to-cycle --cycle-id 20000 --project-id 10000 --version-id -1 --issues EFP-T1,EFP-T2 --folder-id 40000 --dry-run --json"},
