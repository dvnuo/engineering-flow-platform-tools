...
func NewRootWithRunner(r probe.Runner) *cobra.Command {
	...
	c.AddCommand(probeCmd(o, r), sessionCmd(o), tabCmd(o), pageCmd(o), frameCmd(o), networkCmd(o), downloadCmd(o), commandsCmd(o), schemaCmd(o), helpLLMCmd(o), versionCmd(o))
...
func browserLLMTips() []string {
	return []string{
		...
		"Use browser network start/list/wait/stop/clear for sanitized HAR-lite metadata after recording starts; it returns no headers, cookies, storage, or bodies.",
		...
		"browser page screenshot writes a PNG artifact and returns file metadata, not image bytes.",
