...
func browserExplicit(name string) (explicitMeta, bool) {
	...
	items := map[string]explicitMeta{
		...
		"bookmark.add": {Description: "Add a website bookmark to the configured local file source selected by --source; create its manifest and parent directory on first write.",
			Flags: append([]string{"source", "name", "alias", "description", "url"}, common...), Required: []string{"source", "name", "description", "url"}, Risk: "write", Example: `browser bookmark add --source personal --name Google --alias 谷歌 --description "Search the public web." --url https://www.google.com/ --json`,
		...
		"bookmark.update": {Description: "Update selected fields of a website bookmark in the configured local file source selected by --source.",
			Flags: append([]string{"source", "name", "alias", "clear-aliases", "description", "url"}, common...), Required: []string{"source"}, Risk: "write", Example: `browser bookmark update Google --source personal --description "Search public websites." --json`,
		...
		"bookmark.remove": {Description: "Remove a website bookmark from the configured local file source selected by --source after explicit confirmation.",
			Flags: append([]string{"source", "yes"}, common...), Required: []string{"name", "source", "yes"}, Risk: "delete", Example: "browser bookmark remove Google --source personal --yes --json",
